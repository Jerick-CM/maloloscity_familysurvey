...
export default {
    ...
    setup(props) {
        ...
        const updateCheck = async () => {
            ...
            await updateChecklist_data({ ...form }).then(() => {
        ...
        const removeChecklist = (index) => {
            ...
            checklist_form.value.splice(index, 1);
        };
        ...
        <div class="py-2">
            <div class="w-full mx-auto sm:px-6 lg:px-8">
                ...
                <div id="template" class="">
                    ...
                    <form class="" @submit.prevent="updateCheck">
                        <div>
                            <div class=" md:grid-cols-3 md:gap-6">
                                ...
                                <div class="mt-5 md:mt-0 md:col-span-2">
                                    <div v-if="errors_checklist">
                                        <div
                                            v-for="(v, k) in errors_checklist"
                                            :key="k"
